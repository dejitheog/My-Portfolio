...
//                 color: "rgba(255,255,255,0.55)", fontSize: 14, fontFamily: "'DM Sans', sans-serif",
...
//       justifyContent: "center", padding: "80px 2rem 0", position: "relative",
//       overflow: "hidden",
//     }}>
//       {/* grid bg */}
//       <div style={{
...
//         padding: "32px",
//         cursor: "pointer",
//         transition: `all 0.3s ease, opacity 0.6s ease ${index * 120}ms, transform 0.6s ease ${index * 120}ms`,
...
//         color: hovered ? "#A8FF3E" : "rgba(255,255,255,0.35)",
...
// function Work() {
//   return (
//     <section id="work" style={{ padding: "120px 2rem", maxWidth: 1200, margin: "0 auto" }}>
//       <AnimSection>
//         <div style={{ marginBottom: 60 }}>
//           <div style={{
//             fontFamily: "'DM Mono', monospace",
//             fontSize: 11, color: "#A8FF3E", letterSpacing: "0.15em",
//             marginBottom: 16,
//           }}>01 — SELECTED WORK</div>
//           <h2 style={{
//             fontFamily: "'Syne', sans-serif",
...
// function About() {
//   return (
//     <section id="about" style={{ padding: "120px 2rem", maxWidth: 1200, margin: "0 auto" }}>
...
//         <span style={{ color: "#A8FF3E", fontFamily: "'DM Mono', monospace" }}>
//           {skill.level}%
//         </span>
//       </div>
//       <div style={{
...
//                 }}>
//                   Deep-diving into Next.js, TypeScript, and motion design with
//                   Framer Motion to level up my frontend and design capabilities.
//                 </p>
//               </div>
//             </div>
//           </AnimSection>
...
//   return (
//     <section id="contact" style={{ padding: "120px 2rem", maxWidth: 1200, margin: "0 auto" }}>
//       <AnimSection>
//         <div style={{ marginBottom: 60 }}>
//           <div style={{
//             fontFamily: "'DM Mono', monospace",
...
//             {[
//               ["Name", "name", "text", "Peculiar David"],
//               ["Email", "email", "email", "peculiar@example.com"],
